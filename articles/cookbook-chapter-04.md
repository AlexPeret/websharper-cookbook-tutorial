- [Chapter 04 - Site Navigation and more about the routing system](#sec-1)
  - [Navigation](#sec-1-1)
    - [Navigation bar component](#sec-1-1-1)
    - [Using the navigation base component](#sec-1-1-2)
  - [Routing system revisited - client side routing](#sec-1-2)
    - [Client side routing](#sec-1-2-1)

# Chapter 04 - Site Navigation and more about the routing system<a id="sec-1"></a>

## Navigation<a id="sec-1-1"></a>
...
This component is building a Bootstrap Navbar, based on the user authentication status.
...
We started by adding routing support to the server side at first, and later, adding support to the client side. But it is not working properly, at the moment.
